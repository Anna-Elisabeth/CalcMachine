...
if(args.length == 0){
    ...
    System.out.println("Operation code and two numeric values are required");
}

static void performCalculations(){
        MathEquation[] equations = new MathEquation[4];
           equations[0] = new MathEquation (MathOperation.DIVIDE, 100.0, 50.0);
    equations[1] = new MathEquation (MathOperation.ADD, 25.0, 92.0);
    equations[2] = new MathEquation (MathOperation.SUBTRACT, 255.0, 92.0);
    equations[3] = new MathEquation (MathOperation.MULTIPLY, 2.0, 2.0);
